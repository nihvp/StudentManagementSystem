...
3. **Report Card Generation**:
   ...
   - Export student data to a professionally formatted PDF
...
- The `tabulate` library installed. You can install it using:
  ...
  ```
- The `reportlab` library installed. You can install it using:
...
- **StudentManagementSystem.py**: The main Python script containing the program logic.
- **Report_Card_{studentID}.pdf**: Generated report file when using the export feature
